...
class HandInterface:
    ...
    def callback(self, data):
        ...
        #                 gripper_desired = gripper_pinch when pinch_start <= glove < pinch_end
            ...
            glove_pinch_start[0] = glove_pinch[0] - 0.3
            glove_pinch_end[0] = glove_pinch[0] + 0.1

            glove_pinch_start[1] = glove_pinch[1] - 0.25
            glove_pinch_end[1] = glove_pinch[1] + 0.1
            
            glove_pinch_start[2] = glove_pinch[2] - 0.2
            glove_pinch_end[2] = glove_pinch[2] + 0.1
            
            glove_pinch_start[3] = glove_pinch[3] - 0.2
            glove_pinch_end[3] = glove_pinch[3] + 0.1
        ...
        self.last_input = self.glove_current
